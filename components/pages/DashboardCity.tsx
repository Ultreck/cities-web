        ...
        <div className="hidden sticky top-0 lg:block space-y-4">
                ...
                >
                  ...
                  <Button
                    ...
                    className={`bg-blue-600 text-white hover:bg-blue-700 ${
                      community.joined ? "bg-gray-100 text-black hover:bg-slate-100" : ""
                    }`}
                  >
          ...
          <div className="grid grid-cols-1  gap-6">
            <div>
              ...
              <p className="text-slate-600">Create beautiful posts with multiple images. Control who can see your content.</p>
            </div>
            <div>
              <h4 className="font-semibold text-slate-900 mb-2 flex items-center gap-2">
              ...
              <p className="text-slate-600">See who viewed and liked your posts. Connect with engaged users.</p>
            </div>
            <div>
              <h4 className="font-semibold text-slate-900 mb-2 flex items-center gap-2">
              ...
              <p className="text-slate-600">Browse products and list your own items for sale with detailed descriptions.</p>
            </div>
            <div>
              <h4 className="font-semibold text-slate-900 mb-2 flex items-center gap-2">
              ...
              <p className="text-slate-600">Connect with users, like posts, and build meaningful relationships.</p>
            </div>
          </div>
        </Card>
        </div>
