...
function Dashboard() {
  ...
  // Sample data
  const communities = [
    { id: 1, name: 'Lekki Community', members: '35k', image: '🏘️', status: 'Public' },
    { id: 2, name: 'Victoria Island', members: '235k', image: '🌆', status: 'Public' },
          ...
          <main className="flex-1 min-w-0">
                            ...
                            <CardContent className="pt-6">
                              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                <div className="flex-1">
                                  ...
                                  <div className="mt-2 font-semibold text-primary">{job.salary}</div>
                                </div>
                                <Button>Apply</Button>
                              </div>
                            </CardContent>
                      ...
                      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        {properties.map(property => (
                          <Card key={property.id} className="hover:shadow-lg transition-shadow">
                            <CardHeader>
                              <div className="text-6xl text-center py-4">{property.image}</div>
            ...
            {activeTab === 'rewards' && (
              <div className="space-y-6">
                ...
                <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    { title: 'Refer a Friend', points: '+100 pts', icon: UserPlus },
                    { title: 'Post Daily', points: '+10 pts', icon: MessageCircle },
                    { title: 'Join Community', points: '+50 pts', icon: Users },
                    { title: 'Attend Event', points: '+75 pts', icon: Calendar },
                    { title: 'Complete Profile', points: '+25 pts', icon: User },
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Use your points to get exclusive benefits</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-3">
                    {[
                      { name: 'N1,000 Airtime', cost: '500 pts', available: true },
                      { name: 'Premium Badge', cost: '1,000 pts', available: true },
                      { name: 'Event Ticket', cost: '2,000 pts', available: true },
                      { name: 'N5,000 Transfer', cost: '2,500 pts', available: false },
                    ].map((item, idx) => (
